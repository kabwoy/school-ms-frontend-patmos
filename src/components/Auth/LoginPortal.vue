        ...
        methods:{
            handleLogin(){
                ...
                if(this.username.trim()==='' || this.password.trim()=== ''){
                    return this.fieldsAreValid = false
                }
                const authBody = {
                ...
                this.$store.dispatch('loginAsParent' , authBody).then(()=>{
