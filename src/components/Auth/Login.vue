    ...
    export default {
        ...
        methods: {
            async handleLogin() {
                ...
                this.loading = true
                this.$store.dispatch('loginStaff', {email: this.email, password: this.password}).then(()=>{
                    this.loading = false
                    if(this.getServerErr){
        ...
        computed:{
            ...
            getServerError() {
                return this.$store.getters.getServerErr
            }
        ...
        watch: {
            ...
            email() {
                ...
                this.error = null
                this.$store.state.serverSideError = null
            },
            password() {
                this.error = null
                this.$store.state.serverSideError = null
